...
Liceo Scientifico background; learning Python, AWS, and software
engineering practices in my spare time.
...
🥴 **[cellar-tracker](https://github.com/thisisfed/cellar-tracker)**: [one-line description of what it does — e.g. inventory/batch tracking for the cellar, what stack, what problem it solves].
